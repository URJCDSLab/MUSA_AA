...
(Pista: tiene que ver con la estabilidad de la solución).
...
¿Qué información estamos perdiendo al representar únicamente dos dimensiones del conjunto de datos?
(Repasa el capítulo @sec-reddim sobre reducción de la dimensionalidad).
:::
